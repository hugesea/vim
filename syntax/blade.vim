...
syn keyword bladeTarget enable_if gen_rule gen_dep lex_yacc_library proto_library java_jar
syn keyword resource_library swig_library

" Sorted by alphabet order
syn keyword bladeArg always_run cmd data defs deprecated deps dynamic_link
